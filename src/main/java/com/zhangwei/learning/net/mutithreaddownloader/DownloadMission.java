package com.zhangwei.learning.net.mutithreaddownloader;
...
public class DownloadMission {
	...
	private ArrayList<RecoveryRunnableInfo> mRecoveryRunnableInfos = new ArrayList<RecoveryRunnableInfo>();
